...
const Media = () => {
    const { data: articles = [] } = useQuery({
        queryKey: ['articles'],
        queryFn: async () => {
            const res = await fetch('https://post-media-app-server.vercel.app/articles');
        ...
        <div>
            <div class="container mx-auto flex flex-wrap py-6">
                ...
                <aside class="w-full md:w-1/3 flex flex-col items-center px-3">
                    ...
                    <div class="w-full bg-gray-700 shadow flex flex-col my-4 p-6">
                        <p class="text-xl font-semibold pb-5 text-teal-200">About Us</p>
                        <p class="pb-2 text-white">Post media is blog site when you can post your childhood cartoon memory and we can back to the old days.</p>
                        <Link to="/" class="w-full bg-teal-200 text-gray-700 font-bold text-sm uppercase rounded hover:bg-purple-700 hover:text-white flex items-center justify-center px-2 py-3 mt-4">
                            Post Your Memory
                        </Link>
                    </div>

                    <div class="w-full bg-gray-700 shadow flex flex-col my-4 p-6">
                        <p class="text-xl font-semibold pb-5 text-white">Instagram</p>
                        ...
                        <a href="#" class="w-full bg-teal-200 text-gray-700 font-bold text-sm uppercase rounded hover:bg-purple-700 hover:text-white flex items-center justify-center px-2 py-3 mt-6">
                            <i class="fab fa-instagram mr-2"></i> Follow @linkedin
                        </a>
                    </div>
